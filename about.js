document.addEventListener('DOMContentLoaded', function() {
    ...
    const employees = [
        ...
        { name: 'Dan Ruggeri', position: 'Acquisition Specialist', imageUrl: 'DanWebPic.jpg', department: 'Specialists', bio: 'Stephen Christy has evolved through the Construction and Civil Engineering Industry into the President/ CEO of Sustainable Energy Professionals Inc. In the fast paced world.' },
        ...
        { name: 'Nicole Christy', position: 'Executive Assistant', imageUrl: 'Nicole.PNG', department: 'Specialists', bio: 'Nicole Christy handles all day to day scheduling as well as any in office tasks, Nicole shows up everyday with a will to work and a smile on her face.' },
